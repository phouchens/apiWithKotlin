...
class AnswerController(
    ...
    fun getAnswerByQuestionId(@PathVariable questionId: Long): List<Answer> = answerRepository.findByQuestionId(questionId)
    ...
    fun updateAnswer(@PathVariable questionId: Long, @PathVariable answerId: Long, @Valid @RequestBody answerRequest: Answer
    ): Answer {
